	    ...
	    public list() {
	        ...
	        try {
	           ...
	           // Class.forName("com.mysql.jdbc.Driver");
	            ...
	            PreparedStatement pstm = conn.prepareStatement("SELECT * FROM projects");
	            ResultSet Rs = pstm.executeQuery();
	            while(Rs.next()){
	                model.addRow(new Object[]{Rs.getInt(1), Rs.getString(2),Rs.getString(3),Rs.getString(4),Rs.getString(5),Rs.getInt(7)});
	            }
	        } catch (Exception e) {
	            System.out.println(e.getMessage());
	        }
	        JScrollPane pg = new JScrollPane(jtbl);
	        pg.setBounds(10,10,180,180);
